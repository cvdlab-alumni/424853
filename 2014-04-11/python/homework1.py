...
sezpianoUltimo=STRUCT([sezpol0,T([1])([1.3])]*9)
pianoUltimo=STRUCT([sezpol3,T([1])([0.35]),sezpianoUltimo,T([1])([1.3*9]),sezpol3])
northtemp= STRUCT([sezpiano,T([2])([2.5])]*6)
north=STRUCT([northtemp,T([2])([2.5*6])(pianoUltimo)])
...
#SCALE
step= CUBOID([1.3/8,2.5/(3*8),1.3/2])
#box= CUBOID([1.3/2,2.5/3,1.3/2])
stair_temp= STRUCT([step,T([1,2])([1.3/(2*8),2.5/(3*8)])]*8)
floorStair=CUBOID([1.3/2,2.5/(3*8),1.3/2])
stair_partial1= STRUCT([COLOR(RED)(stair_temp),COLOR(GREEN)(T([1,2])([1.3/2,(7*2.5)/(3*8)])(floorStair))])
stair_partial2=T([1,2,3])([1.3/2,2.5/3,0])(R([1,3])(-PI/2)(stair_partial1))
stair_partial3=T([1,2,3])([1.3/2,(2.5*2)/3,-1.3/2])(R([1,3])(-PI)(stair_partial1))
stair_total = STRUCT([stair_partial1,stair_partial2,stair_partial3])

stair1=T([1,3])([(1.3*11)/2,(1.3*10)/2])(R([1,3])(PI/2)(stair_total))
stair2=T([1,3])([(1.3*12)/2,(1.3*8)/2])(R([1,3])(-PI/2)(stair_total))

stair_left= STRUCT([stair1,T([2])([2.5])]*5)
stair_right = STRUCT([stair2,T([2])([2.5])]*5)


finalmodelNoFloor= T([2,3])([1.3*9+0.35*2,0.50])(R([2,3])(PI/2)(STRUCT([north3D,south3D,east3D,west3D])))

finalModel3D = T([2,3])([1.3*9+0.35*2,0.50])(R([2,3])(PI/2)(STRUCT([solid_model_3D,stair_left,stair_right])))
#VIEW(STRUCT([solid_model_3D,stair_left,stair_right]))
#VIEW(finalModel3D)